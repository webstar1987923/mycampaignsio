...
$stylesheets = array(
    ...
    array( "rel" => "stylesheet", "href" => base_url( 'themes/site/default/new-ui/assets/css/calendar.css' ) ),   // Used in 'Business Overview'.
    // array( "rel" => "stylesheet", "href" => "https://unpkg.com/tachyons@4.7.0/css/tachyons.min.css" ),   // @note: Use instead local version. Recheck!
    array( "rel" => "stylesheet", "href" => base_url( 'themes/site/default/new-ui/assets/css/tachyons.min.css' ) ),
    array( "rel" => "stylesheet", "href" => base_url( 'themes/site/default/new-ui/assets/css/body.min.css' ) ),
    array( "rel" => "stylesheet", "href" => base_url( 'themes/site/default/new-ui/assets/css/forms.min.css' ) ),
    array( "rel" => "stylesheet", "href" => base_url( 'themes/site/default/new-ui/assets/css/general.min.css' ) ),
    array( "rel" => "stylesheet", "href" => base_url( 'themes/site/default/new-ui/assets/css/sidebar.min.css' ) ),
    array( "rel" => "stylesheet", "href" => base_url( 'themes/site/default/new-ui/assets/css/main-section-layout.min.css' ) ),
    array( "rel" => "stylesheet", "href" => base_url( 'themes/site/default/new-ui/assets/css/styles.min.css' ) ),
);
