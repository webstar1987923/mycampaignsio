...
<div class="ciuis-body-content">
	<?php echo form_open('proposals/add',array("class"=>"form-horizontal main-content container-fluid col-xs-12 col-md-12 col-lg-9 invoice-form")); ?>
	<input class="relationer" name="relation_type" type="hidden" value="0">
		...
		<div class="panel-body" style="padding:30px 20px;">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="input-group"><span class="input-group-addon"><i class="ion-information"></i></span>
						<input required="" type="text" name="subject" value="<?php echo $this->input->post('subject'); ?>" class="form-control" id="subject" placeholder="<?php echo lang('subject') ?>">
					</div>
				</div>
				<div class="col-md-12 md-m-0 md-p-0">
					<div class="form-group">
						...
						<div class="col-md-5 md-pr-0 customer-select">
						...
						<div class="col-md-5 md-pr-0 lead-select" style="display: none">
							<label for="leads">
								<?php echo lang('leads'); ?>
							</label>
				...
				<div class="col-md-12 md-m-0 md-p-0">
					<div class="form-group">
						<div class="col-md-6 md-pl-0">
							...
							<select required name="assigned" class="form-control select2">
								<?php
			...
			<div class="col-md-6 md-pl-30">
				...
				<div class="form-group has-warning">
					...
					<div data-min-view="2" data-date-format="dd.mm.yyyy" class="input-group date datetimepicker"> <span class="input-group-addon btn btn-default"><i class="icon-th mdi mdi-calendar"></i></span>
						<input placeholder="<?php echo date(" d.m.Y "); ?>" type='input' name="opentill" value="<?php echo $this->input->post('opentill'); ?>" class="form-control" id="opentill"/>
					</div>
				</div>
				<div class="form-group pull-right">
					<div class="ciuis-body-checkbox has-primary">
						<input name="comment" class="primary-check" id="comment" type="checkbox" value="1">
						<label for="comment">
			...
			<div class="col-md-12">
			<div class="form-group md-p-0">
				<textarea name="content" id="replyeditor" cols="30" rows="10"><?php echo $this->input->post('content'); ?></textarea>
			</div>
			</div>
		</div>
