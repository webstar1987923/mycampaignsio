				...
				<div class="ciuis-body-left-sidebar">
					<div class="left-sidebar-wrapper">
						...
						<div class="left-sidebar-spacer">
							<div class="left-sidebar-scroll">
								<div class="left-sidebar-content">
									<ul class="sidebar-elements hidden-xs">
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('dashboard') ?>"><a class="huppur" href="<?php echo base_url('panel'); ?>"><span class="ion-ios-analytics-outline"></span></a>
										</li>
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('customers') ?>"><a class="huppur" href="<?php echo base_url('customers'); ?>"><span class="ico-ciuis-customers"></span></a>
										</li>
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('leads') ?>"><a class="huppur" href="<?php echo base_url('leads'); ?>"><span class="ico-ciuis-leads"></span></a>
										</li>
										<?php if (!if_admin) {echo '<li data-toggle="tooltip" data-placement="right" data-container="body" title="' . lang('accounts') . '"><a class="huppur" href="' . base_url('accounts') . '"><span class="ico-ciuis-accounts"></span></a>
										</li>';}?>
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('invoices') ?>"><a class="huppur" href="<?php echo base_url('invoices'); ?>"><span class="ico-ciuis-invoices"></span></a>
										</li>
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('proposals') ?>"><a class="huppur" href="<?php echo base_url('proposals'); ?>"><span class="ico-ciuis-proposals"></span></a>
										</li>
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('expenses') ?>"><a class="huppur" href="<?php echo base_url('expenses'); ?>"><span class="ico-ciuis-expenses"></span></a>
										</li>
										<?php if (!if_admin) {echo '<li data-toggle="tooltip" data-placement="right" data-container="body" title="' . lang('staff') . '"><a class="huppur" href="' . base_url('staff') . '"><span class="ico-ciuis-staff"></span></a>
										</li>';}?>
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('tickets') ?>"><a class="huppur" href="<?php echo base_url('tickets'); ?>"><span class="ico-ciuis-supports"></span></a>
										</li>
										<?php if (!if_admin) {echo '<li data-toggle="tooltip" data-placement="right" data-container="body" title="' . lang('reports') . '"><a class="huppur" href="' . base_url('report') . '"><span class="ico-ciuis-reports"></span></a>
										</li>';}?>
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('products') ?>"><a class="huppur" href="<?php echo base_url('products'); ?>"><span class="ico-ciuis-products"></span></a>
										</li>
										<li class="divider"></li>
									</ul>
									<ul class="sidebar-elements hidden-lg hidden-md hidden-sm">
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('dashboard') ?>">
											<a class="huppur" href="<?php echo base_url('panel'); ?>">
												<?php echo lang('dashboard') ?>
											</a>
										</li>
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('customers') ?>">
											<a class="huppur" href="<?php echo base_url('customers'); ?>">
												<?php echo lang('customers') ?>
											</a>
										</li>
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('leads') ?>">
											<a class="huppur" href="<?php echo base_url('leads'); ?>">
												<?php echo lang('leads') ?>
											</a>
										</li>
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('accounts') ?>">
											<a class="huppur" href="<?php echo base_url('accounts'); ?>">
												<?php echo lang('accounts') ?>
											</a>
										</li>
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('invoices') ?>">
											<a class="huppur" href="<?php echo base_url('invoices'); ?>">
												<?php echo lang('invoices') ?>
											</a>
										</li>
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('proposals') ?>">
											<a class="huppur" href="<?php echo base_url('proposals'); ?>">
												<?php echo lang('proposals') ?>
											</a>
										</li>
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('expenses') ?>">
											<a class="huppur" href="<?php echo base_url('expenses'); ?>">
												<?php echo lang('expenses') ?>
											</a>
										</li>
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('staff') ?>">
											<a class="huppur" href="<?php echo base_url('staff'); ?>">
												<?php echo lang('staff') ?>
											</a>
										</li>
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('tickets') ?>">
											<a class="huppur" href="<?php echo base_url('tickets'); ?>">
												<?php echo lang('tickets') ?>
											</a>
										</li>
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('reports') ?>">
											<a class="huppur" href="<?php echo base_url('report'); ?>">
												<?php echo lang('reports') ?>
											</a>
										</li>
										<li data-toggle="tooltip" data-placement="right" data-container="body" title="<?php echo lang('products') ?>">
											<a class="huppur" href="<?php echo base_url('products'); ?>">
