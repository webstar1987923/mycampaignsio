						...
						<div class='container-fluid'>
							<div class='top-header_customer-xs'>
								<div class='row'>
									...
									<div style="padding-right: 20px;" class='col-md-6 hidden-xs'>
...
?>
    ...
    ?>
						<tr data-filterable data-filter-country="<?php echo $f['isocode'] ?>" class="ciuis-254325232345" onclick="window.location='<?php echo base_url('customers/customer/' . $f['id'] . '') ?>'">
							<td class="md-ml-15">
								<div class="ciuis-34525452"><span class="title uppercase"><a style="color: #383838;font-weight: 700;" href="<?php echo site_url('customers/customer/' . $f['id']); ?>"><?php if ($f['type'] == 0) {
        echo $f['companyname'];
    } else {
        echo $f['namesurname'];
    } ?></a></span><br>
    ...
    if ($riskstatus->row()->risk < 1) {
        ...
        if ($riskstatus->row()->risk > 50) {
            ...
            echo '<label style="margin-bottom: 0px;margin-top: 5px;font-weight: 600;font-size: 10px;">' . lang('riskstatus') . '</label>
							...
							<td>
								<div class="text-center pull-right md-mr-15">
