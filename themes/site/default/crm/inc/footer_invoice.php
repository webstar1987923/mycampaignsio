...
<script src="<?php echo base_url(); ?>assets/crm/lib/jquery-ui/jquery-ui.min.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>assets/crm/lib/jquery.nestable/jquery.nestable.js" type="text/javascript"></script>
...
<script src="<?php echo base_url(); ?>assets/crm/lib/bootstrap-slider/js/bootstrap-slider.js" type="text/javascript"></script>
...
<script src="<?php echo base_url(); ?>assets/crm/js/jquery.form.min.js"></script>
<script src="<?php echo base_url(); ?>assets/crm/js/jquery.tools.js"></script>
<link href="<?php echo base_url(); ?>assets/crm/css/bootstrap-editable.css" rel="stylesheet">
<script src="<?php echo base_url(); ?>assets/crm/js/bootstrap-editable.min.js"></script>
<?php include_once dirname(dirname(__FILE__)) . '/inc/invoicegenerator.php';?>
...
<script src='<?php echo base_url('themes/site/default/new-ui/assets/js/campaigns-io-script.js'); ?>'></script>
